...
-- don't need this since I have swapped caps lock and escape
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          --  comment out Tab and S-Tab, arrow key is enough for me
          --  Leave tab for copilot
      ...
      neotest.setup({
        ...
        adapters = {
          require("neotest-python")({
              ...
              python = "/home/jason/.cache/pypoetry/virtualenvs/course-nc6xrDgT-py3.13/bin/python",
